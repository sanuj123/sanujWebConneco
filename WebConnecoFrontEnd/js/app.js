var app = angular.module('conneco',['ngSanitize','ui.select']);
...
app.directive('openMenuByClick', function ($timeout) {
    return {
...
app.controller('connecoCtrl',function ($scope) {
